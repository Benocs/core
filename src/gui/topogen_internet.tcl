...
proc generateInternet {} {

    # this method draws the GUI window
    ...
    pack $wi.router.line1.label -side left
...
proc initTopogenInternetPrefs {} {
    ...
    array set testing_prefs {
        ...
        gui_brite_bottom2_briteout  "/tmp/topoOut"
        gui_brite_bottom2_loadcfg   "/tmp/out.cfg"
        gui_brite_bottom3_imnout    "/tmp/topoOut"
        gui_brite_bottom3_loadbrite "/tmp/topoOut.brite"
        gui_brite_bottom4_imnin     "/tmp/topoOut.imn"
        gui_brite_bottom_execpath   "/usr/lib/brite"
        gui_brite_bottom_savedest   "/tmp/out.cfg"
    }
}
